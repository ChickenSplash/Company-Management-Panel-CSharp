    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Company>().HasData(
                new Company { Id = 1, Name = "Tech Corp", Email = "info@techcorp.com", Logo="placeholder.png", Website = "https://techcorp.com" },
                new Company { Id = 2, Name = "Health Inc", Email = "contact@healthinc.com", Logo = "placeholder.png", Website = "https://healthinc.com" }
            );
